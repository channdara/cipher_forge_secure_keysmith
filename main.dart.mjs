...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      GJ: (x0,x1) => { x0.spellcheck = x1 },
      H: Function.prototype.call.bind(Number.prototype.toString),
      HB: x0 => new Float64Array(x0),
      HC: x0 => x0.remove(),
      HD: x0 => x0.top,
      HE: o => o.length,
      HF: (x0,x1) => x0.error(x1),
      ...
      WI: x0 => x0.style,
      WJ: (x0,x1) => x0.getModifierState(x1),
      X: o => [o],
      XB: (t, s) => t.set(s),
      XC: x0 => x0.userAgent,
      XD: x0 => x0.shiftKey,
      ...
      bD: (a, i, v) => a[i] = v,
      bE: x0 => x0.x,
      bF: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      ...
      cE: x0 => x0.scrollTop,
      cF: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      cG: (x0,x1) => { x0.type = x1 },
      cH: x0 => x0.done,
      ...
      rE: x0 => x0.tiltY,
      rF: (x0,x1) => x0.querySelectorAll(x1),
      ...
      wG: x0 => x0.readText(),
      wH: () => Date.now(),
      wI: (x0,x1,x2) => x0.insertBefore(x1,x2),
